 ...
 189  0019 9e            	ld	a,xh
 190  001a c75347        	ld	21319,a
 191                     ; 72   TIM4->ARR = (uint8_t)(TIM4_Period);
 193  001d 9f            	ld	a,xl
 194  001e c75348        	ld	21320,a
 195                     ; 73 }
 198  0021 81            	ret	
 ...
 677  006c 9e            	ld	a,xh
 678  006d c75347        	ld	21319,a
 679                     ; 225   TIM4->EGR = (uint8_t)TIM4_PSCReloadMode;
 681  0070 9f            	ld	a,xl
 682  0071 c75345        	ld	21317,a
 683                     ; 226 }
 686  0074 81            	ret	
